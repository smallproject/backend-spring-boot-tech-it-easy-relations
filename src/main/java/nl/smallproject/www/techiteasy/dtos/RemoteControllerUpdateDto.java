...
public class RemoteControllerUpdateDto {
    ...
    public void setBatteryType(@NotBlank(message = "{remoteController.batteryType.notblank}") @Size(min = 1, max = 255, message = "{remoteController.batteryType.size}") String batteryType) {
